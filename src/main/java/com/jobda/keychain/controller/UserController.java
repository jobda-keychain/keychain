...
public class UserController {
    ...
    public void createUser(HttpServletRequest servletRequest,
        ...
        userService.createUser(LogUtil.getClientIp(servletRequest), request);
    }
    ...
    public UpdateAccountResponse updateUser(HttpServletRequest servletRequest,
        ...
        return userService.updateUser(LogUtil.getClientIp(servletRequest), id, request);
    }
    ...
    public void deleteUser(HttpServletRequest servletRequest,
        ...
        userService.deleteUser(LogUtil.getClientIp(servletRequest), id);
    }
    ...
    public DetailsResponse detailsUser(HttpServletRequest servletRequest,
                                       @PathVariable long id) {
        return userService.detailsUser(LogUtil.getClientIp(servletRequest), id);
    }
